...
PIC Operasional
- PIC Utama: ______________________
- PIC Cadangan: ______________________
- Kontak Resmi: ______________________

Peran Developer Pasca-Penutupan
1. Peran pengembang dibatasi pada bugfix melalui prosedur change control.
2. Tidak ada penambahan fitur baru.
3. Tidak ada perubahan yang mengubah prinsip event-based & role per event.
4. Tidak ada perubahan yang menjadikan evaluasi/KAP sebagai syarat kelulusan.
5. Kelulusan tetap merupakan keputusan rapat manusia; sistem hanya mencatat.

Jalur Komunikasi Resmi
- Kanal Internal: ______________________
- Email Distribusi: ______________________
- Hotline/Telepon Darurat (P0): ______________________
